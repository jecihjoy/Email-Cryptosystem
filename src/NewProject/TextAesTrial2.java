 ...
 * @author JoyGich
 */
public class TextAesTrial2 extends javax.swing.JFrame {
    ...
    //constru...
    public TextAesTrial2(String key) {
...
//        demo = text.getText();
        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                   ...
                   // demotxt = text.getText();
                    demo = text1.getText();
                    text1.setText("");
                    //text.setText("");
                    
                    //System.out.println(demo);
                   // demo3 = encrypt(demotxt);
                    demo2 = encrypt(demo);
                    ...
                    Logger.getLogger(TextAesTrial2.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        button2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    //demosub = decrypt(demo3);
                    //System.out.println(demo2);
                    demomessage = decrypt(demo2);
                    //text.setText(demosub);
                    text1.setText(demomessage);
                    //JOptionPane.showMessageDialog(null, "Successfully decrypted" + demomess   age);
                } catch (Exception ex) {
                    Logger.getLogger(TextAesTrial2.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public static String encrypt(String Data) throws Exception {
        ...
        byte[] encvalue = c.doFinal(Data.getBytes());//method used to encryp data. data is first converted into bytes.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TextAesTrial2("qwertyuizxcvbnmm").setVisible(true);
                try {
                } catch (Exception ex) {
